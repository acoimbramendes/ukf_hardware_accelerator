...
static void emlrt_marshallOut(const real_T u[1024], const mxArray *y);
  ...
  static const mxArray *d_emlrt_marshallOut(const real_T u[2080])
{
  ...
  static const int32_T iv4[2] = { 32, 65 };
 ...
 */
  static void emlrt_marshallOut(const real_T u[1024], const mxArray *y)
{
  static const int32_T iv0[2] = { 32, 32 };
...
void ut_api(const mxArray *prhs[6], const mxArray *plhs[4])
{
  ...
  prhs[3] = emlrtProtectR2012b(prhs[3], 3, false, -1);
  prhs[5] = emlrtProtectR2012b(prhs[5], 5, false, 1024);
