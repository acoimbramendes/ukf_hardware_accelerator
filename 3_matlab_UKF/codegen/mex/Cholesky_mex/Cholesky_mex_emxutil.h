/*
 * Cholesky_mex_emxutil.h
 *
 * Code generation for function 'Cholesky_mex_emxutil'
 *
 */

#ifndef CHOLESKY_MEX_EMXUTIL_H
#define CHOLESKY_MEX_EMXUTIL_H
...
/* End of code generation (Cholesky_mex_emxutil.h) */
