...
//altfp_sqrt CBX_AUTO_BLACKBOX="ALL" DEVICE_FAMILY="Cyclone V" PIPELINE=16 ROUNDING="TO_NEAREST" WIDTH_EXP=8 WIDTH_MAN=23 aclr clk_en clock data overflow result zero
...
module  fpsquare_alt_sqrt_block_ocb
	( 
	aclr,
	clken,
	clock,
...
endmodule //fpsquare_alt_sqrt_block_ocb

//synthesis_resources = lpm_add_sub 27 reg 763 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fpsquare_altfp_sqrt_31f
	( 
	aclr,
	clk_en,
	clock,
...
`endif
	...
	fpsquare_alt_sqrt_block_ocb   alt_sqrt_block2
	( 
	.aclr(aclr),
	.clken(clk_en),
	.clock(clock),
	...
	assign
		...
		zero = zero_ff;
endmodule //fpsquare_altfp_sqrt_31f
//VALID FILE
...
module fpsquare (
	...
	fpsquare_altfp_sqrt_31f	fpsquare_altfp_sqrt_31f_component (
				.aclr (aclr),
				.clk_en (clk_en),
				.clock (clock),
				.data (data),
