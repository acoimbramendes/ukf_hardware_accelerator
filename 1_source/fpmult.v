...
//altfp_mult CBX_AUTO_BLACKBOX="ALL" DEDICATED_MULTIPLIER_CIRCUITRY="YES" DENORMAL_SUPPORT="NO" DEVICE_FAMILY="Cyclone V" EXCEPTION_HANDLING="NO" PIPELINE=5 REDUCED_FUNCTIONALITY="NO" ROUNDING="TO_NEAREST" WIDTH_EXP=8 WIDTH_MAN=23 aclr clk_en clock dataa datab overflow result underflow zero
...
`endif
	...
	assign
		...
		zero = zero_ff;
endmodule //fpmult_altfp_mult_72r
//VALID FILE
...
module fpmult (
	...
	fpmult_altfp_mult_72r	fpmult_altfp_mult_72r_component (
				.aclr (aclr),
				.clk_en (clk_en),
				.clock (clock),
				.dataa (dataa),
