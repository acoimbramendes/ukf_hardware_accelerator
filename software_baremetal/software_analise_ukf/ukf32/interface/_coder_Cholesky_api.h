...
extern void Cholesky(real_T A[1024]);
...
extern real_T measurement_eq(real_T x[32]);
extern void measurement_eq_api(const mxArray *prhs[1], const mxArray *plhs[1]);
extern void nonlinear_state_eq(real_T x[32], real_T f[32]);
extern void nonlinear_state_eq_api(const mxArray *prhs[1], const mxArray *plhs[1]);
extern void sigmas(real_T x[32], real_T P[1024], real_T c, real_T X[2080]);
extern void sigmas_api(const mxArray *prhs[3], const mxArray *plhs[1]);
extern void ukf(real_T x[32], real_T P[1024], real_T z, real_T Q[1024], real_T R);
extern void ukf_api(const mxArray *prhs[5], const mxArray *plhs[2]);
extern void ut(real_T eq, real_T X[2080], real_T Wm[65], real_T Wc[65], real_T n,
